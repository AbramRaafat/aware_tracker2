...
# Our MOT20
python detect.py -f "exps/yolox_x_mot20_test.py" -c "/kaggle/input/mot-20-model-only-best/pytorch/default/1/best_ckpt.pth.tar" -b 1 -d 1 -n "../outputs/1. det/MOT20_test_nms_0.8.pickle" --fp16 --fuse
```
